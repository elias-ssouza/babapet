...
public interface UserDAO extends JpaRepository<User, java.lang.String> {
   ...
   * @generated
   */
  @Query("SELECT entity.dono FROM Pet entity WHERE entity.user.id = :id")
  public Page<Dono> listDono(@Param(value="id") java.lang.String id, Pageable pageable);
   ...
   */
  @Modifying
  @Query("DELETE FROM Pet entity WHERE entity.user.id = :instanceId AND entity.dono.id = :relationId")
  public int deleteDono(@Param(value="instanceId") java.lang.String instanceId, @Param(value="relationId") java.lang.String relationId);
